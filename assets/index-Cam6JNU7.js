...
aut aut aut maxime quia temporibus ut omnis`}],Pc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Lc=({user:e})=>e?$.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}):null,Tc=({comment:e})=>$.jsxs("div",{className:"CommentInfo",children:[$.jsxs("div",{className:"CommentInfo__title",children:[$.jsx("strong",{className:"CommentInfo__name",children:e.name||"Anonymous"})," by ",$.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),$.jsx("div",{className:"CommentInfo__body",children:e.body||"No content available."})]}),Mc=({post:e})=>$.jsxs("div",{className:"PostInfo",children:[$.jsxs("div",{className:"PostInfo__header",children:[$.jsx("h3",{className:"PostInfo__title",children:e.title}),$.jsxs("p",{children:[" Posted by  ",$.jsx(Lc,{user:e.user})]})]}),$.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments&&e.comments.length>0?e.comments.map(t=>$.jsx(Tc,{comment:t},t.id)):$.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Rc=({posts:e})=>$.jsx("div",{className:"PostList",children:e.map(t=>$.jsx(Mc,{post:t},t.id))});function tm(e){return Pc.find(t=>t.id===e)||null}const Dc=zc.map(e=>({...e,user:tm(e.userId)})),jc=Nc.map(e=>({...e,user:tm(e.userId)})),Oc=()=>$.jsxs("section",{className:"App",children:[$.jsx("h1",{className:"App__title",children:"Static list of posts"}),$.jsx("div",{className:"PostList",children:$.jsx(Rc,{posts:Dc,comments:jc})})]});em(document.getElementById("root")).render($.jsx(Oc,{}));
